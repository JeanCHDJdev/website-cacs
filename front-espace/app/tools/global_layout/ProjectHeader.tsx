...
const ProjectHeader: React.FC<ProjectHeaderProps> = ({bg, title, subtitle, patch}) => {
    return (
        <div>
            <img src={bg} style={{ objectFit: 'cover', objectPosition: 'center top', filter: 'brightness(78%)',  height: '30rem', width:'100%',  position: 'relative', zIndex: 1, backgroundPosition: 'center' }} />
